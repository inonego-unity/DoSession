...
```
https://github.com/inonego-unity/DoSession.git?path=com.inonego.dosession
```
...
{
  "dependencies": {
    "com.inonego.dosession": "https://github.com/inonego-unity/DoSession.git?path=com.inonego.dosession"
  }
}
```
